...
class PolicyNetwork(nn.Module):
    def __init__(self, state_dim, action_dim, discrete=True):
        ...
        #self.enco =nn.Linear(16, d_model)
        ...
        self.enc = TransformerEncoder(d_model, d_ff, n_heads=n_heads, dropout=dropout)
    ...
    def forward(self, states):
        ...
        # print('states',states)
        # print('weights:', self.enco[0].weight)
        states_encod=self.enco(states)
        # print('states_encod',states_encod)
        ...
        #cov_mtx += torch.eye(self.action_dim) * 1e-4 
